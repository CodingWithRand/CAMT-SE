...
//     const titleText = titleEl?.textContent?.trim() || `Untitle Blog`;
...
//                 showToast(error.error || 'An error occurred while logging out. Please try again.');
//                 return;
//             }
...
//     document.querySelectorAll('.post').forEach(post => addEditEventListeners(post));
...
//         if (query.length === 0) {
//             searchPostsContainer.innerHTML = '<p class="text-xs text-slate-500 py-2">Start typing to search posts on your feed...</p>';
//             searchPeopleContainer.innerHTML = '<p class="text-xs text-slate-500 py-2">Start typing to search author of the post on your feed...</p>';
//             return;
//         }
...
//             searchPostsContainer.innerHTML = '<p class="text-xs text-slate-500 py-2">No posts found</p>';
//         } else {
...
//                     <p class="text-xs text-slate-600 dark:text-slate-400 mt-1 line-clamp-1">${post.description || 'No description available'}</p>
//                 </a>
//             `).join('');
//         }
...
//             searchPeopleContainer.innerHTML = '<p class="text-xs text-slate-500 py-2">No people found</p>';
//         } else {
...
//             document.getElementById('blogs-container').querySelector('.nopost').innerHTML = `No posts found for your search <b>"${urlsq}"</b>.`
//         }
//     }
...
//             document.getElementById('blogs-container').innerHTML = '<div class="text-center py-8"><p class="dark:text-slate-400 text-slate-600">Searching...</p></div>';
...
//                     if(csred.owner) addEditEventListeners(post);
//                     addSearchData(post)
//                 }))
//             } else {
//                 document.getElementById('blogs-container').innerHTML = `<div class="text-center py-8"><p class="dark:text-slate-400 text-slate-600">No posts found for your search <b>"${searchQuery}"</b>.</p></div>`;
//             }
...
//             document.getElementById('blogs-container').innerHTML = '<div class="text-center py-8"><p class="text-red-600">An error occurred while searching. Please try again.</p></div>';
//         }
//     });
